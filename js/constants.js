export const MODELS = {
    "SDXL_LIGHTNING_4STEP": {
        ...
        images: [
            ...
            "https://replicate.delivery/yhqm/UX9eovtlFP0EAaeVdqzrTSff4PM0U9xTInBJkqBU2mcH1L2NB/out-0.png",
            ...
            "https://replicate.delivery/yhqm/06gwNfgAZi2rYS3ORentbR6YTUctegebfeNfjf9em6Ayo7F7mA/out-0.png",
            "https://replicate.delivery/yhqm/nTMezRPSm4xXX6yGVVkKePeRMeC0Lwq9p4o02APPeV1mwXsbC/out-0.png",
            "https://replicate.delivery/yhqm/UFpx4sZ5oGKUFVZwI9jbfadgov4hbBbDeDPTCybieRbi8F7mA/out-0.png"
        ],
        description: "A fast SDXL-based model optimized for rapid image generation in just four denoising steps, balancing speed and quality for efficient workflows.", 
        avg_time: "TBD" 
    },
    "SDXL_MULTI_CONTROLNET_LORA": {
    ...
    "KANDINSKY_2_2": {
        ...
        images: [
            ...
            "https://replicate.delivery/pbxt/h1FRZp5d5gZfHyyKTA8vJfjAVXbMv4BI5GkkVfVkp1HjMceEB/out-0.png",
            "https://replicate.delivery/pbxt/C3TyPTuH1ALBBZ2IcgAcq7H8c2Ednsep2J14EmXyW3WhDnnIA/out-0.png",
            "https://replicate.delivery/pbxt/tfZNO0eYA4lLJUKX7ypmgV9tktMCMOQZ682S8zzN3JAvIOPRA/out-0.png",
            "https://replicate.delivery/pbxt/CnQ9S5cCxraIHtueXUUEfe4TyQmHmk9CeMx8g9rwpxWFt48EB/out-0.png",
            "https://replicate.delivery/pbxt/yllavn6d5pZtIl2X17lkx6MdKVKzAvb8Sp9rWrecUcDvHnnIA/out-0.png",
        ],
        description: "An advanced text-to-image diffusion model that combines CLIP and diffusion techniques, offering improved image quality and prompt alignment.",
        avg_time: "TBD"
    },
    "KANDINSKY_2_1": {
        name: "Kandinsky 2.1",
        ...
        description: "A predecessor to Kandinsky 2.2, this model merges CLIP and diffusion models to generate images from text with a focus on artistic styles.",
        avg_time: "TBD"
    },
    "LATENT_CONSISTENCY": {
        ...
        images: [
            ...
            "https://replicate.delivery/pbxt/gixujfS8h0Q5MyBjEQ1ABVeeHJgs2wcQqZUeEhblne9ntkNOC/out-0.png",
        ],
    ...
    "STABLE_DIFFUSION": {
        ...
        images: [
            ...
            "https://replicate.delivery/pbxt/aooDunhAPcbUBh979fEblu4qqohEtlG0dPJUf1aLuUkMowCQA/out-0.png",
            "https://replicate.delivery/mgxm/980bca24-f8d8-41bb-9f52-fe84bca9c251/out-0.png",
            "https://replicate.delivery/mgxm/0d5e6ce0-dd85-4dd8-a087-a9c59876b456/out-0.png"
        ],
        description: "The original open-source text-to-image model that set the standard for diffusion-based image generation with a balance of quality and accessibility.",
        avg_time: "TBD"
    },
    "SSD1B": {
        name: "SSD-1B",
        ...
        images: [
            ...
            "https://replicate.delivery/pbxt/aPdpZ8LGpBLOEh5yDYr2kMDE9t599ZD7z8aCldcdABzkew4IA/out-0.png",
        ...
        description: "A streamlined diffusion model tailored for efficient image synthesis, focusing on speed without significant compromises in quality.",
        avg_time: "TBD"
    },
    "PLAYGROUND_V2": {
        name: "Playground V2",
    ...
    "PLAYGROUND_V25": {
        ...
        images: [
            ...
            "https://replicate.delivery/pbxt/m4yzAf16weulKktxX6vWoYlIzXEVs1K27yzPXKl7fsY8MNBlA/out-0.png",
            "https://replicate.delivery/pbxt/xGJLmC0sKY4iJ1nh9tcebjIA7GvpJsXG1yMK8rgrUi6uUTQJA/out-0.png",
            "https://replicate.delivery/pbxt/xGJLmC0sKY4iJ1nh9tcebjIA7GvpJsXG1yMK8rgrUi6uUTQJA/out-0.png"
        ],
        description: "An enhanced version of Playground v2, offering improved aesthetic quality and consistency in 1024px image generation tasks.",
        avg_time: "TBD"
    },
    "FLUX_1_1_PRO": {
        name: "Flux 1.1 Pro",
        ...
        description: "A professional-grade model designed for high-fidelity image generation, catering to users seeking detailed and realistic outputs.",
        avg_time: "TBD"
    },
    "REALVISXL_V3_MULTI_CONTROLNET_LORA": {
        ...
        description: "An SDXL-based model combining RealVisXL V3 with multiple ControlNet and LoRA modules for enhanced control and photorealism.",
        avg_time: "TBD"
    },
    "REALVISXL_V3_0_TURBO": {
        ...
        images: [
            ...
            "https://replicate.delivery/pbxt/Ziz8oH4wHkIXNd4pnpEYNTSbVgWbMmReNNDxoRdVX5iyfGHSA/out-0.png",
            "https://replicate.delivery/pbxt/uVObfqHAH2XfpE4QqO8ex1J9e6UlQvGiLmjRLJxj7u4tEccIB/out-0.png",
        ],
        description: "A turbocharged version of RealVisXL V3.0, optimized for faster image generation while maintaining high-quality outputs.",
        avg_time: "TBD"
    },
    "REALVISXL_V4_0": {
        name: "RealVisXL V4.0",
        ...
        description: "A fine-tuned SDXL model focusing on photorealism, offering detailed and realistic image generation capabilities.",
        avg_time: "TBD"
    },
    "REALVISXL_V2": {
        name: "RealVisXL V2.0",
    ...
    "STICKER_MAKER": {
        ...
        images: [
            ...
            "https://replicate.delivery/pbxt/NX0pxsueaLxCZKUf3sh9kM5PDPJBHSqoyyELv6DRuHqAhkZSA/ComfyUI_00002_.png"
        ],
        description: "An AI model designed to generate sticker graphics with transparent backgrounds, suitable for various digital applications.",
        avg_time: "TBD"
    },
    "DREAMSHAPER_XL_TURBO": {
        ...
        images: [
            ...
            "https://replicate.delivery/pbxt/u3pfEmHrHj17Vql7qB4oJzOrIQjJhAoQDQsuco0z8ejc09DSA/out-0.png",
        ...
        description: "A versatile SD model aiming to excel in generating photos, art, anime, and manga, designed to match outputs from Midjourney and DALL·E.",
        avg_time: "TBD"
    },
    "OPEN_DALLE_V1_1": {
        ...
        images: [
            ...
            "https://replicate.delivery/pbxt/R80lnepdvTyEAqZFGTeOGyQfRE9WLNfDGFwT5dfzp5lM79yQC/out-0.png",
            ],
        description: "A fusion model showcasing exceptional prompt adherence and semantic understanding, bridging the gap between base SDXL and DALL·E 3.",
        avg_time: "TBD"
    },
    "PIXART_XL_2": {
        name: "PixArt XL 2",
        ...
        images: [
            ...
            "https://replicate.delivery/pbxt/lmskA7wDkp5eEy5sXTxrxldQDi5JengzdrEpPpdEqiMYgwejA/out-0.png",
            "https://replicate.delivery/pbxt/r8EVULZz0g7jFdBWRSOkFvKhrejcqcf9GOa5w9BHzO4vgwejA/out-0.png",
        ],
        description: "A transformer-based text-to-image diffusion system trained on T5 embeddings, capable of generating 1024px images in a single sampling process.",
        avg_time: "TBD"
    },
    "PROTEUS_V0_3": {
        name: "Proteus V0.3",
        ...
        images: [
            ...
            "https://replicate.delivery/pbxt/KLeR6H1freGlaIRwIOOgDaSSJCG3HHeqiaGY4z8RA1T99zaJB/out-0.png",
            "https://replicate.delivery/pbxt/OFTWAMyFi4o2NlyeUy0rbUNMCmTl75iOrFNZ9UGVobbyhWLJA/out-0.png",
            "https://replicate.delivery/pbxt/ZQbJiK3yDiKoOpHwE7ytoFNjMZXaKCLfYQaU7FU4UWowiWLJA/out-0.png",
        ],
        description: "An enhanced model with added anime-related data, offering improved lighting effects and maintaining photorealistic and stylistic capabilities.", 
        avg_time: "TBD"
    },
    "PROTEUS_V0_4_LIGHTNING": {
        name: "Proteus V0.4 Lightning",
        ...
        images: [
            ...
            "https://replicate.delivery/pbxt/JQW7q8cwLzJ0JlqRT5Eag5kQvle5jbP2OeRxO6RdGNfLvoykA/out-0.png",
            "https://replicate.delivery/pbxt/ehT8ecfRhhUXNIf30pCJaQsnueqc27bd1amXOE6BTjN2wiKTC/out-0.png"],
        description: "A stylistic update to Proteus, enhancing artistic capabilities akin to Midjourney's approach, focusing on style over prompt comprehension.", 
        avg_time: "TBD"
    },
    "THINKDIFFUSIONXL": {
        name: "ThinkDiffusion XL",
        ...
        images: [
            ...
            "https://replicate.delivery/pbxt/uRfY6AaWePqaTEgP1fgtofS0UaOLmyDPbQE8BLHLq0NzMKXHB/out-0.png",
            "https://replicate.delivery/pbxt/FZSzRGG3Sh4LIdYvP7s45F9OZ1uSSeSjBecyKOeHfNhAQKXHB/out-0.png",
            "https://replicate.delivery/pbxt/DZsOfT2zCmRiDKVssXVAyTyfwuejMrSZnYCZHI0gtvO2IlrjA/out-0.png",
            "https://replicate.delivery/pbxt/0Jldb4LnReR1OqXPfuMPFKsuPhDelonuU89w0Q9UVZ4VKlrjA/out-0.png",
            "https://replicate.delivery/pbxt/COpuvU8qxIpQGZqxUiBeu4RNwQouQtugNU2N9a0JZjusT56IA/out-0.png"
        ],
        description: "A photorealistic model trained on over 10,000 diverse images, aiming to generate high-quality images across various styles and subjects without requiring complex prompts.",
        avg_time: "TBD"
    },
    "NEBUL_REDMOND": {
        name: "Nebul Redmond",
        ...
        description: "A generalist model fine-tuned on SDXL 1.0, capable of generating realistic and artistic images across various themes, including cars and people.",
        avg_time: "TBD"
    },
    "RECRAFT_V3": {
        name: "Recraft V3",
        ...
        images: [
            ...
            "https://replicate.delivery/czjl/H3nI3Yyvm9a2ItFz34GXDyx0CcaizxaceGGzKSMLF8vu1B2JA/output.webp",
            "https://replicate.delivery/czjl/XjhXFI0dX5KqClvhCz5cXMicYsOohKjHJYmQicgVFnCX8A7E/output.webp",
        ],
        description: "Also known as red panda, this model excels in generating images with long texts and diverse styles, setting a new standard in image generation quality.",
        avg_time: "8.8 seconds"
    },
    "NVIDIA_SANA": {
        name: "NVIDIA Sana",
        id: "nvidia/sana",
        ...
        images: [
            ...
            "https://replicate.delivery/xezq/yF1Mul5UQCbbO5KXeNyJp4avsj5Hr9xWZpvPPhfNXsylh2zTA/output.png", 
            "https://replicate.delivery/xezq/g2J3cSjBsi7eParE3BcAxHR4XzBDczaBlCn128Dgt4VqR75JA/output.png", 
            "https://replicate.delivery/xezq/UdVbPhKQrWJVG1lRjD4GgP9EIpujzfZXp2sweCsBaRDBk2zTA/output.png"
        ],
        description: "Sana is a high-speed text-to-image model capable of generating images up to 4096x4096 resolution. It utilizes efficient Linear Diffusion Transformer techniques, including DC-AE compression and Linear DiT for enhanced text-image alignment.",
        avg_time: "1.2 seconds"
    },
    "STABLE_DIFFUSION_3_5_LARGE": {
        ...
        description: "Stable Diffusion 3.5 Large is a Multimodal Diffusion Transformer (MMDiT) text-to-image model that enhances image quality, typography, and prompt comprehension using Query-Key Normalization.",
        avg_time: "8.8 seconds"
    },
    "LUMA_PHOTON": {
        name: "Luma Photon",
        ...
        images: [
            ...
            "https://replicate.delivery/czjl/OyX4NVeZGIwZeUuht65DyC3ftG90vqWjeLHRJC7peH5RU6ngC/tmpycexq76l.jpg"
        ],
        description: "Luma Photon is a high-efficiency image generation model optimized for creative professional workflows, ultra-high fidelity outputs, and advanced natural language understanding.",
        avg_time: "11.3 seconds"
    },
    "LUMA_PHOTON_FLASH": {
...
function generateModelSelection() {
    ...
    Object.keys(MODELS).forEach(modelKey => {
        ...
        // Create model box div
        const modelBox = document.createElement("div");
        modelBox.classList.add("model-box");
        modelBox.setAttribute("data-model", modelKey);

        // Create image element with dynamic teaser
